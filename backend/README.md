...
## 🚀 Features
- **Spring Security + JWT**: Stateless token-based authentication with role-based access control (`ROLE_STUDENT`, `ROLE_FACULTY`, `ROLE_LAB_ADMIN`, `ROLE_DEPARTMENT_ADMIN`).
