...
export const FAANG_SECTIONS: PhaseSection[] = [
  // ==========================================
  ...
  // ==========================================
  {
    ...
    description: "Traversals, shortest paths, topological ordering, minimum spanning trees, and network topologies tested heavily in FAANG interviews.",
    items: [
      {
        id: "graph-traversal",
